...
function AdminView({ liveOrders, onExport, onNewOrder, onNewCustomer }: { liveOrders: LiveOrder[]; onExport: () => void; onNewOrder: () => void; onNewCustomer: () => void }) {
...
function CreateCustomerModal({ onClose, onCreated }: { onClose: () => void; onCreated: (customer: any) => void }) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      onCreated(data.customer); onClose();
