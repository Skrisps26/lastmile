...
export function Dashboard() {
  ...
  const content = role === 'customer' ? <CustomerView customerOrders={liveOrders} onCreate={() => setShowCreate(true)} /> : role === 'agent' ? <FunctionalAgentView liveOrders={liveOrders} /> : <AdminView liveOrders={liveOrders} onExport={exportOrders} />;
