...
| M3 | Order Lifecycle & History Ledger (R2) | Order booking, append-only history ledger, state transition validation, failed reschedule | M1, M2 | DONE |
| M4 | Agent Management & Auto-Dispatch (R3) | Agent profiles, zone mappings, availability toggle, auto-assignment algorithm | M1, M3 | DONE |
